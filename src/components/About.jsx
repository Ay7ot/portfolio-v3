    ...
    return (
        <section className='pt-[2rem] pb-[6rem] md:pt-[4rem] md:pb-[8rem] w-full max-w-[1024px]'>
            <div className=" flex md:flex-row flex-col gap-4 md:gap-16 items-center w-full">
                ...
                <div>
                    <p className="flex flex-col gap-[1.25rem] text-[18px] md:text-[1.25rem] leading-[1.75rem] text-[#404968] md:gap-8 font-medium">
            ...
            <div className="bg-white p-3 md:p-12 rounded-[1.25rem] border-[1px] border-[#DCDFEA] mt-24 flex flex-col items-center justify-center">
                ...
                <h4 className="max-w-[600px] mt-10 text-center text-[#30374F] font-bold tracking-[-1.5px] leading-[3rem] md:leading-[86px] text-[2.5rem] md:text-[4rem] lg:text-[4.5rem]">
                    Let&apos;s build the <br /> future together
                </h4>
                <p className="text-[#5D6B98] text-sm md:text-[1.25rem] text-center mt-5 font-medium leading-5 md:leading-[30px]">
                ...
                <div className="flex items-center gap-4 mt-6">
                    <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="underline text-[#0067C2]"
                    >
                    ...
                    <button
                        ...
                        className="py-2 px-4 rounded-lg border-[1px] border-[#B9C0D4] text-xs md:text-sm font-medium leading-5 text-[#404968]"
                    >
                        Copy Email
                    </button>
                </div>
                <div className="md:border-none w-full border-[1px] border-[#DCDFEA] mt-32 flex items-center justify-center md:justify-end rounded-xl py-5">
                    <p className="text-sm md:text-[18px] font-medium leading-5 md:leading-7">Designed by <span className="text-[#0067C2]">The Poe✌️</span></p>
                </div>
            </div>
        </section>
    )
