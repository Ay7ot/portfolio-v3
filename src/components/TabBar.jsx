            ...
            <div className=" p-3 rounded-full border-[0.82px] border-[#DCDFEA] bg-[#FCFCFD] dark:bg-[#4A5578] dark:border-[#5D6B98]">
                <div className="flex items-center gap-2 justify-between dock">
                    <div className='flex flex-col items-center relative'>
                        <a href='#home' className="p-2 sm:p-4 rounded-full bg-[#EFF1F5] min-h-[2.25rem] min-w- border-[0.24px] border-[#DCDFEA] cursor-pointer transition-all duration-300 ease-linear origin-bottom dock-item">
                        ...
                        <div className={`mt-[0.1rem] md:mt-[0.25rem] absolute bottom-[-8px] ${active === 'Home' ? 'visible' : 'invisible'}`}>
                    ...
                    <div className='flex flex-col items-center relative'>
                        <a href='#projectsBody' className="p-2 sm:p-4 rounded-full bg-[#EFF1F5] min-h-[2.25rem] min-w- border-[0.24px] border-[#DCDFEA] cursor-pointer transition-all duration-100 ease-linear origin-bottom dock-item">
                        ...
                        <div className={`mt-[0.1rem] md:mt-[0.25rem] absolute bottom-[-8px] ${active === 'Projects' ? 'visible' : 'invisible'}`}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="6" height="5" viewBox="0 0 6 5" fill="none">
                                <circle cx="3.00005" cy="2.2" r="2.2" fill="#7D89B0" />
                            </svg>
                        </div>
                    ...
                    <div className='flex flex-col items-center relative'>
                        <a href='#about' className="p-2 sm:p-4 rounded-full bg-[#EFF1F5] min-h-[2.25rem] min-w- border-[0.24px] border-[#DCDFEA] cursor-pointer transition-all duration-100 ease-linear origin-bottom dock-item">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="18" viewBox="0 0 16 18" fill="none">
                        ...
                        <div className={`mt-[0.1rem] md:mt-[0.25rem] absolute bottom-[-8px] ${active === 'About' ? 'visible' : 'invisible'}`}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="6" height="5" viewBox="0 0 6 5" fill="none">
                                <circle cx="3.00005" cy="2.2" r="2.2" fill="#7D89B0" />
                            </svg>
                        </div>
                    ...
                    <div className='flex flex-col items-center relative'>
                        <a href='https://twitter.com/TeyeAyo' target='_blank' rel='noreferrer' className="p-2 sm:p-4 rounded-full bg-[#EFF1F5] min-h-[2.25rem] min-w- border-[0.24px] border-[#DCDFEA] cursor-pointer transition-all duration-100 ease-linear origin-bottom dock-item">
                        ...
                        <div className={`mt-[0.1rem] md:mt-[0.25rem] absolute bottom-[-8px] invisible`}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="6" height="5" viewBox="0 0 6 5" fill="none">
                                <circle cx="3.00005" cy="2.2" r="2.2" fill="#7D89B0" />
                            </svg>
                        </div>
                    ...
                    <div className='flex flex-col items-center relative'>
                        <a href='https://github.com/Ay7ot' target='_blank' rel='noreferrer' className="p-2 sm:p-4 rounded-full bg-[#EFF1F5] min-h-[2.25rem] min-w- border-[0.24px] border-[#DCDFEA] cursor-pointer transition-all duration-100 ease-linear origin-bottom dock-item">
                    ...
                    <div className='flex flex-col items-center relative'>
                        <a href='https://www.linkedin.com/in/ayomide-ibiteye-b124b823b/' target='_blank' rel='noreferrer' className="p-2 sm:p-4 rounded-full bg-[#EFF1F5] min-h-[2.25rem] min-w- border-[0.24px] border-[#DCDFEA] cursor-pointer transition-all duration-100 ease-linear origin-bottom dock-item">
                    ...
                    <div className='flex flex-col items-center relative'>
                        <button
                            ...
                            className="p-2 sm:p-4 rounded-full bg-[#EFF1F5] min-h-[2.25rem] min-w- border-[0.24px] border-[#DCDFEA] cursor-pointer transition-all duration-100 ease-linear origin-bottom dock-item"
                        >
                            {theme === 'dark'
                                ?
