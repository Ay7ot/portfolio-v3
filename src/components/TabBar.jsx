            ...
            <div className=" p-3 rounded-full border-[0.82px] border-[#DCDFEA] bg-[#FCFCFD] dark:bg-[#4A5578] dark:border-[#5D6B98]">
                <div className="flex items-center gap-2 justify-between dock">
                    <div className='flex flex-col items-center'>
                        ...
                        <div className={`mt-[0.1rem] md:mt-[0.25rem] ${active === 'Home' ? 'visible' : 'invisible'}`}>
                    ...
                    <div className='flex flex-col items-center'>
                        ...
                        <div className={`mt-[0.1rem] md:mt-[0.25rem] ${active === 'Projects' ? 'visible' : 'invisible'}`}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="6" height="5" viewBox="0 0 6 5" fill="none">
                                <circle cx="3.00005" cy="2.2" r="2.2" fill="#7D89B0" />
                            </svg>
                        </div>
                    ...
                    <div className='flex flex-col items-center'>
                        ...
                        <div className={`mt-[0.1rem] md:mt-[0.25rem] ${active === 'About' ? 'visible' : 'invisible'}`}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="6" height="5" viewBox="0 0 6 5" fill="none">
                                <circle cx="3.00005" cy="2.2" r="2.2" fill="#7D89B0" />
                            </svg>
                        </div>
                    ...
                    <div className='flex flex-col items-center'>
                        ...
                        <div className={`mt-[0.1rem] md:mt-[0.25rem] invisible`}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="6" height="5" viewBox="0 0 6 5" fill="none">
                                <circle cx="3.00005" cy="2.2" r="2.2" fill="#7D89B0" />
                            </svg>
                        </div>
