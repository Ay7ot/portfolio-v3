            ...
            <div className=" p-3 rounded-full border-[0.82px] border-[#DCDFEA] bg-[#FCFCFD] dark:bg-[#4A5578] dark:border-[#5D6B98]">
                <div className="flex items-center gap-2 justify-between dock">
                    <div className='flex flex-col items-center'>
                        ...
                        <p className={`text-[#5D6B98] text-[1.2rem] mt-[-0.60rem] items-center leading-4 font-semibold ${active === 'Home' ? 'visible' : 'invisible'}`}>.</p>
                    </div>
                    ...
                    <div className='flex flex-col items-center'>
                        ...
                        <p className={`text-[#5D6B98] text-[1.2rem] mt-[-0.60rem] items-center leading-4 font-semibold ${active === 'Projects' ? 'visible' : 'invisible'}`}>.</p>
                    </div>
                    <div className='flex flex-col items-center'>
                        ...
                        <p className={`text-[#5D6B98] text-[1.2rem] mt-[-0.60rem] items-center leading-4 font-semibold ${active === 'About' ? 'visible' : 'invisible'}`}>.</p>
                    </div>
                    ...
                    <div className='flex flex-col items-center'>
                        ...
                        <p className='text-[#111322] text-[1.2rem] mt-[-0.60rem] items-center leading-4 font-semibold invisible'>.</p>
                    </div>
                    <div className='flex flex-col items-center'>
