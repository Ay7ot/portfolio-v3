    ...
    return (
        <div className="header_background p-3 pb-12 w-full max-w-[1024px]">
            ...
            <div className="mt-32 md:mt-[252px] sm:px-12 md:px-24">
                ...
                <p className="mt-8 text-[18px] font-medium leading-7 text-[#4A5578]">
                    I&apos;m Ayomide, lover of music, anime, manga and...
                </p>
                <h1 className="text-[#30374F] text-[2.5rem] md:text-[3.75rem] lg:text-[4.5rem] font-bold leading-[3rem] md:leading-[4rem] lg:leading-[5rem] lg:tracking-[-1.5px] mt-3">
